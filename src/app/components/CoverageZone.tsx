      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{
          ...
          <div ref={textRef} className="t4c-reveal">
            <span className="t4c-section-label">Zone d'intervention</span>
            <h2 style={{
            ...
            <p style={{
              ...
              Nous intervenons en Wallonie et en Flandre. Partout en Belgique (hors Bruxelles-Capitale) pour les interventions directes.
            </p>
